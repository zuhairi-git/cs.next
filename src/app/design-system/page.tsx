...
function Swatch({ name, value, className }: { name: string; value: string; className: string }) {
  return (
    <div className="glass-card p-6 flex items-center justify-between gap-6">
      <div>
        <div className="text-[var(--starlight)] font-bold">{name}</div>
        <div className="text-sm text-[var(--text-muted)] font-mono">{value}</div>
      </div>
      <div className={`w-12 h-12 rounded-2xl border border-[var(--glass-border)] ${className}`} />
    </div>
  );
}
        ...
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-8">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mt-8 mb-6 leading-tight text-[var(--starlight)]">
            ...
            <aside className="lg:col-span-4 lg:sticky lg:top-28">
              <GlassCard className="p-8">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-4">QUICK LINKS</div>
                <div className="flex flex-col gap-3 text-sm text-[var(--text-muted)]">
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#colors">Colors</Link>
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#typography">Typography</Link>
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#buttons">Buttons</Link>
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#cards">Cards</Link>
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#forms">Forms</Link>
                  <Link className="hover:text-[var(--starlight)] transition-colors" href="#icons">Icons</Link>
                </div>
              </GlassCard>
            </aside>
          </div>
          ...
          <section id="colors" className="pt-20">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Colors</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              <Swatch name="Space Black" value="--space-black" className="bg-[var(--space-black)]" />
              ...
              <Swatch name="Glass BG" value="--glass-bg" className="bg-[var(--glass-bg)]" />
              <Swatch name="Glass Border" value="--glass-border" className="bg-[var(--glass-border)]" />
            </div>
          </section>

          {/* Typography */}
          <section id="typography" className="pt-24">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Typography</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">HEADINGS</div>
                <div className="space-y-4 text-[var(--starlight)]">
              ...
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">GRADIENT TEXT</div>
          ...
          <section id="buttons" className="pt-24">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Buttons</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">PRIMARY (.btn-primary)</div>
              ...
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">SECONDARY (glass border)</div>
                <div className="flex flex-wrap gap-4 items-center">
          ...
          <section id="cards" className="pt-24">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Cards</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
              <GlassCard className="p-10">
                <div className="w-16 h-16 rounded-2xl bg-[var(--glass-bg)] border border-[var(--glass-border)] flex items-center justify-center mb-8">
                  <i className="fa-duotone fa-thin fa-rocket text-3xl text-[var(--icon-purple)]"></i>
                </div>
                <h3 className="text-2xl font-bold text-[var(--starlight)] mb-4">Glass Card</h3>
              ...
              <GlassCard className="p-10 border-l-4 border-l-purple-500">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">ACCENTED</div>
                <h3 className="text-2xl font-bold text-[var(--starlight)] mb-4">Border Accent</h3>
                <p className="text-[var(--text-muted)] leading-relaxed">
              ...
              <GlassCard className="p-10 relative overflow-hidden border-purple-500/50 shadow-[0_0_40px_-10px_rgba(124,58,237,0.3)]">
                ...
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">FEATURED</div>
                <h3 className="text-2xl font-bold text-[var(--starlight)] mb-4">Highlighted Plan</h3>
                <p className="text-[var(--text-muted)] leading-relaxed">
          ...
          <section id="forms" className="pt-24">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Forms</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">FIELDS</div>
                <div className="space-y-6">
                  <div className="space-y-2 text-left">
                    <label className="text-xs font-bold tracking-widest text-[var(--text-muted)] ml-4">CALLSIGN</label>
                    <input
                      type="text"
                      className="w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-full px-6 py-4 text-[var(--starlight)] focus:outline-none focus:border-purple-500 focus:bg-[var(--glass-border)] transition-all"
                      placeholder="Name"
                    />
                  </div>
                  <div className="space-y-2 text-left">
                  ...
                  <div className="space-y-2 text-left">
                    ...
                    <textarea
                      rows={4}
                      className="w-full bg-[var(--glass-bg)] border border-[var(--glass-border)] rounded-3xl px-6 py-4 text-[var(--starlight)] focus:outline-none focus:border-purple-500 focus:bg-[var(--glass-border)] transition-all resize-none"
                      placeholder="Message"
                    />
                  </div>
                </div>
              ...
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">STATUS + SUBMIT</div>
                <div className="space-y-4">
          ...
          <section id="icons" className="pt-24">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-[var(--starlight)]">Icons</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <GlassCard className="p-10">
                <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-6">DUOTONE THIN</div>
                <div className="flex flex-wrap items-center gap-6 text-[var(--icon-purple)]">
                  <i className="fa-duotone fa-thin fa-rocket text-4xl"></i>
                  <i className="fa-duotone fa-thin fa-bullseye text-4xl text-[var(--icon-blue)]"></i>
                  <i className="fa-duotone fa-thin fa-gem text-4xl text-[var(--icon-pink)]"></i>
          ...
          <section className="pt-24">
            <GlassCard className="p-10 text-center">
              <div className="text-xs font-bold tracking-widest text-[var(--text-muted)] mb-4">NEXT</div>
              <h3 className="text-2xl font-bold mb-4 text-[var(--starlight)]">Extract components gradually</h3>
